...
// All of these functions can be moved into their own actions file to be a bit more readable, no need to have them in the same file as our index page
export function getWatchedMovies() {
  var movies = localStorage.getItem("movies-watched");

  if (!movies) {
    return [];
    // personal prefrence, but else statements aren't needed here
  } else {
...
// not needed to make this a function, can call ReactDOM.render directly
function render() {
  ReactDOM.render(
